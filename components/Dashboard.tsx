  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen md:h-screen bg-[#050505] text-white font-sans md:overflow-hidden selection:bg-pink-500/30 relative">
      ...
      <div className="flex-1 flex flex-col md:flex-row relative overflow-visible md:overflow-hidden">
        ...
        >
            ...
            <div className="flex-1 flex items-center justify-center p-4 md:p-8 relative md:pt-16">
                ...
                <div className="absolute inset-0 pointer-events-none z-20 overflow-hidden">
                    ...
                    <div className="absolute top-[15%] right-[8%] md:top-[5%] md:right-[20%] animate-float opacity-60 scale-75 md:scale-90" style={{ animationDelay: '0.8s' }}>
                    ...
                    <Send className="absolute bottom-[25%] left-[15%] md:left-[25%] text-white/5 w-10 h-10 animate-pulse-slow hidden md:block" style={{ animationDelay: '1s' }} />
                </div>
        ...
        <div ref={resultsRef} className="w-full md:w-[300px] h-auto md:h-full flex-1 bg-[#050505] md:bg-[#0a0a0a] md:border-l border-transparent md:border-white/5 flex flex-col md:shadow-2xl z-20 order-2 md:order-2 md:overflow-hidden">
