      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-sm shadow-2xl">
          <div className="flex items-center gap-6 mb-12 pb-8 border-b border-white/5">
            <div className="p-4 bg-purple-500/10 rounded-2xl border border-purple-500/20 shadow-inner shadow-purple-500/10">
              {icon}
            </div>
            <div>
              ...
              <p className="text-gray-500 mt-2 text-sm font-medium">
                Última atualização: <span className="text-purple-400">{lastUpdated}</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            {isPrivacy ? (
              <>
                ...
                <Section title="4. Compromisso do Usuário">
                  <p>
                  ...
                  <ul className="list-none space-y-3 mt-4">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</span>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-purple-500 font-bold">C)</span>
                      <span>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Puxe Assunto, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span>
                    </li>
                  </ul>
                </Section>
              ...
              <>
                ...
                <Section title="2. Uso de Licença">
                  <p>
                  ...
                  <ul className="list-disc list-inside space-y-2 marker:text-purple-500 ml-2">
                ...
                <Section title="5. Precisão dos materiais">
                  <p>
