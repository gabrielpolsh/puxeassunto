      ...
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-full shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-all hover:scale-105"
          >
            <svg
              viewBox="0 0 24 24"
